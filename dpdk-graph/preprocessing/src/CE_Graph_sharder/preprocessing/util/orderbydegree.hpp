...
#ifndef DEF_CE_Graph_ORDERBYDEGREE
#define DEF_GRAPH
...
namespace CE_Graph {
    ...
    /**
      * Override the basic CE_Graph vertex class and use this for reprocessing the edges. Hack.
      */
    template <typename VT, typename ET>
    class special_sharding_vertex : public CE_Graph_vertex<VT, ET> {
    public:
        
        sharder<ET, ET> * sharderobj;
        vid_t * translatetable;
        special_sharding_vertex() {}
        special_sharding_vertex(sharder<ET, ET> * _sharderobj, vid_t _id, vid_t * _translatetable) : CE_Graph_vertex<VT, ET> (_id, NULL, NULL, 0, 0) { 
