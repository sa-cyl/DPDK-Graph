...
struct SubgraphsProgram : public CE_GraphProgram<VertexDataType, EdgeDataType> {
...
int main(int argc,  const char *argv[]) {
  ...
  logstream(LOG_WARNING)<<"CE_Graph graph analytics library is written by Danny Bickson (c). Send any "
  ...
  num_active = 0;
  CE_Graph_engine<VertexDataType, EdgeDataType> engine(datafile, nshards, false, m); 
