 ...
 *
*  File for converting graph in SNAP format to CE_Graph CF toolkit format.
*  See SNAP format explanation here: http://docs.graphlab.org/graph_formats.html
* See CE_Graph matrix market format here: http://bickson.blogspot.co.il/2012/02/matrix-market-format.html
*/
