 ...
 *  6 6 050803 68
 *
 *  Namely, a text file where the first field is a "from" field (CE_Graph >=1), second field is a "to" field (CE_Graph > = 1)
...
void parse(int i){    
  ...
  size_t line = 1;
  double total = 0;
  CE_Graph from = 0, to = 0;
  CE_Graph last_from = 0, last_to = 0;
  while(true){
