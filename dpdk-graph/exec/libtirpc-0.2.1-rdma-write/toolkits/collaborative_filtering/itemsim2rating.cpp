...
class adjlist_container {
  public:
     ...
     */
    int load_edges_into_memory(CE_Graph_vertex<uint32_t, EdgeDataType> &v) {
     ...
     *
     */
    double compute_ratings(CE_Graph_vertex<uint32_t, EdgeDataType> &item, vid_t user_pivot, int distance_metric) {
