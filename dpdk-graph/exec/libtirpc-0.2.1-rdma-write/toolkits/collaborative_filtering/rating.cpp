...
struct RatingVerticesInMemProgram : public CE_GraphProgram<VertexDataType, EdgeDataType> {
...
int main(int argc, const char ** argv) {
  ...
  if (tokens_per_row == 3){
    ...
    CE_Graph_engine<VertexDataType, edge_data4> engine(training, nshards, false, m); 
    set_engine_flags(engine);
    engine.run(program, 1);
  }
