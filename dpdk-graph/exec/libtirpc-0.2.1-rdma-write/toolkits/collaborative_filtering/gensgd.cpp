...
#include <omp.h>
#define CE_Graph_DISABLE_COMPRESSION //remove this if you want to save memory but increase runtime
...
CE_Graph_engine<VertexDataType, EdgeDataType> * pengine = NULL; 
...
void training_rmse_N(int iteration, CE_Graph_context &gcontext, bool items = false){
 ...
 */
struct GensgdVerticesInMemProgram : public CE_GraphProgram<VertexDataType, EdgeDataType> {
