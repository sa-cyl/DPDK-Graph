...
CE_Graph_engine<VertexDataType, EdgeDataType> * pvalidation_engine = NULL; 
 ...
 */
struct TIMESVDPPVerticesInMemProgram : public CE_GraphProgram<VertexDataType, EdgeDataType> {
