#ifndef __CE_Graph_MRR_ENGINE
#define __CE_Graph_MRR_ENGINE
/**
 * @file
 * @author  Mark Levy
 * @version 1.0
 ...
 */
struct ValidationMRRProgram : public CE_GraphProgram<VertexDataType, EdgeDataType> {
...
void init_mrr_engine(CE_Graph_engine<VertexDataType,EdgeDataType> *& pvalidation_engine, int nshards)
{
  if (nshards == -1)
    return;
