#ifndef __CE_Graph_RMSE_ENGINE4
#define __CE_Graph_RMSE_ENGINE4
/**
 * @file
 ...
 */
struct ValidationRMSEProgram4 : public CE_GraphProgram<VertexDataType, EdgeDataType> {
...
void init_validation_rmse_engine(CE_Graph_engine<VertexDataType,EdgeDataType> *& pvalidation_engine, int nshards,float (*prediction_func)(const vertex_data & user, const vertex_data & movie, float rating, double & prediction, void * extra), bool _time_weighting, bool _time_nodes, int _matlab_time_offset){
...
template<typename VertexDataType, typename EdgeDataType>
void run_validation4(CE_Graph_engine<VertexDataType, EdgeDataType> * pvalidation_engine, CE_Graph_context & context){
