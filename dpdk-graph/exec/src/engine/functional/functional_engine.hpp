 ...
 * @section DESCRIPTION
 *
 * Engine for the alternative "functional" API for CE_Graph.
 * The functional engine first processes in-edges, then executes "updates",
 * and then loads and updates out-edges.
 */


#ifndef CE_Graph_FUNCTIONALENGINE_DEF
#define CE_Graph_FUNCTIONALENGINE_DEF
...
namespace CE_Graph {
    ...
    class functional_engine : public CE_Graph_engine<VertexDataType, EdgeDataType,  fvertex_t> {
    public:
        functional_engine(std::string base_filename, int nshards, bool selective_scheduling, metrics &_m) :
        CE_Graph_engine<VertexDataType, EdgeDataType, fvertex_t>(base_filename, nshards, selective_scheduling, _m){
    ...
    protected:
        ...
        virtual void init_vertices(std::vector<fvertex_t> &vertices, CE_Graph_edge<EdgeDataType> * &e) {
