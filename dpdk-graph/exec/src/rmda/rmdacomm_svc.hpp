...
#include "rmda/server.hpp"
#include "rmda/rmdacomm_xdr.hpp"
...
{
	union {
		data_arg block_write_1_arg;
		data_req block_read_1_arg;
	} argument;
	char *result;
	...
	case BLOCK_WRITE:
		...
		local = (char *(*)(char *, struct svc_req *)) block_write_1_svc;
		break;

	case BLOCK_READ:
		_xdr_argument = (xdrproc_t) xdr_data_req;
		_xdr_result = (xdrproc_t) xdr_data_arg;
		local = (char *(*)(char *, struct svc_req *)) block_read_1_svc;
		break;
